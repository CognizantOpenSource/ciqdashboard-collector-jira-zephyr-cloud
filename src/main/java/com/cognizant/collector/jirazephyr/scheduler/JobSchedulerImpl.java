...
package com.cognizant.collector.jirazephyr.scheduler;
...
public class JobSchedulerImpl implements BatchEvents {
    @Autowired
    private JiraComponent jiraComponent;
    @Autowired
    private JiraIssueComponent jiraIssueComponent;

    @Override
    public void beforeJob() {
        log.info("Before Job process........!");
        jiraComponent.getIssues();
    }
